  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at 20% 20%, rgba(56, 189, 248, 0.25), transparent 45%), radial-gradient(circle at 80% 70%, rgba(37, 99, 235, 0.3), transparent 50%), linear-gradient(135deg, #0F172A, #1E3A8A)'
        }}
      >
        ...
        <div className="relative z-10">
          <span className="px-3.5 py-1.5 bg-white/10 backdrop-blur-md rounded-full text-[10px] font-bold uppercase tracking-widest text-blue-200 border border-white/10 w-fit">
        ...
        <div className="relative z-10 space-y-5">
          ...
          <div className="flex flex-wrap gap-2 pt-2">
            <span className="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 backdrop-blur-sm rounded-full text-[10px] font-bold text-slate-200 border border-white/10">
            ...
            <span className="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 backdrop-blur-sm rounded-full text-[10px] font-bold text-slate-200 border border-white/10">
              <span className="w-1.5 h-1.5 rounded-full bg-purple-400"></span> Báo cáo doanh thu
            </span>
          </div>
        </div>

        {/* Bottom: Slogan Card */}
        <div className="relative z-10 bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-4 flex items-center gap-3 max-w-sm">
          <div className="w-9 h-9 rounded-xl bg-blue-600 text-white flex items-center justify-center font-bold text-base shadow-md">
            L
          </div>
          <div>
            <h4 className="font-extrabold text-xs tracking-wide">Lành Sạch Laundry</h4>
            <p className="text-[9px] text-blue-200 uppercase tracking-widest font-bold mt-0.5">Sạch Thơm Tin Tưởng</p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[47.5%] bg-white p-8 sm:p-12 flex flex-col justify-between">
        ...
        <div className="lg:hidden flex items-center gap-2 pb-6 border-b border-slate-100 mb-6">
          ...
          <div>
            <h4 className="font-black text-xs text-slate-800">Lành Sạch</h4>
            <p className="text-[9px] text-slate-400 uppercase tracking-widest font-bold">Sạch Thơm Tin Tưởng</p>
          </div>
        </div>
        ...
        <div className="my-auto space-y-6">
          ...
          <div className="space-y-3">
            <div className="hidden lg:flex w-12 h-12 rounded-2xl bg-blue-600 text-white items-center justify-center font-black text-xl shadow-lg shadow-blue-500/25">
              L
            </div>
            <div>
              <h3 className="hidden lg:block text-sm font-bold text-slate-500 uppercase tracking-wider">Lành Sạch</h3>
              <h2 className="text-2xl font-black text-slate-900 tracking-tight mt-1">Đăng nhập hệ thống</h2>
              <p className="text-xs font-semibold text-slate-400 mt-1">Sạch Thơm Tin Tưởng</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full h-11 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-xl font-bold text-xs shadow-md transition-all active:scale-[0.99] flex items-center justify-center gap-1.5"
              disabled={loading}
            >
              <LogIn size={14} />
          ...
          <div className="relative flex items-center justify-center py-2">
            ...
            <span className="absolute bg-white px-3 text-[10px] text-slate-400 font-bold uppercase tracking-widest">Hoặc</span>
          </div>
          ...
          <button
            ...
            type="button"
            className="w-full h-11 border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.99]"
            disabled={loading}
          >
