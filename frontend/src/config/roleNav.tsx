...
export const ROLE_NAV: Record<Role, NavItem[]> = {
  admin: [
    ...
    { path: 'branches', name: 'Quản lý chi nhánh', icon: <MapPin size={20} /> },
    ...
    { path: 'content', name: 'Nội dung', icon: <Newspaper size={20} /> },
  ...
  manager: [
    ...
    { path: 'branches', name: 'Quản lý chi nhánh', icon: <MapPin size={20} /> },
    { path: 'orders', name: 'Đơn hàng', icon: <FileText size={20} /> },
    { path: 'reports', name: 'Báo cáo doanh thu cơ sở', icon: <TrendingUp size={20} /> },
  ...
  staff: [
    ...
    { path: 'payroll', name: 'Tính lương', icon: <DollarSign size={20} /> },
    { path: 'reports', name: 'Báo cáo doanh thu ca/ngày', icon: <TrendingUp size={20} /> },
    { path: 'chat', name: 'Chat', icon: <MessageSquare size={20} /> },
    { path: 'settings', name: 'Cài đặt', icon: <Settings size={20} /> },
  ],
};
